            ...
            <div class="modal-body">
                <form action="submit.php" method="post" enctype="multipart/form-data" class="needs-validation"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input value="alan@gmail.com" type="email" class="form-control form-control-sm" name="input_email"
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input value="metube2020" type="password" class="form-control form-control-sm" name="input_password"
